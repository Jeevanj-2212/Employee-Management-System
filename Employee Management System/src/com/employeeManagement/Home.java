...
public class Home extends JFrame {
	...
	public Home() {
		...
		JButton btn2 = new JButton("View Emp By ID");
		...
		btn4.addActionListener(e -> {
		    // Open the new page
		    RemoveEmployee v = new RemoveEmployee();
		    v.setVisible(true);
		...
		sl_contentPane.putConstraint(SpringLayout.NORTH, btn5, 600, SpringLayout.NORTH, contentPane);
		sl_contentPane.putConstraint(SpringLayout.WEST, btn5, 250, SpringLayout.WEST, contentPane);
		sl_contentPane.putConstraint(SpringLayout.SOUTH, btn5, -46, SpringLayout.SOUTH, contentPane);
		sl_contentPane.putConstraint(SpringLayout.EAST, btn5, -250, SpringLayout.EAST, contentPane);
		contentPane.add(btn5);
		btn5.addActionListener(e -> {
		    // Open the new page
		    UpdateEmployee v = new UpdateEmployee();
		    v.setVisible(true);
